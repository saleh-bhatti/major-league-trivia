...
import NFLOverUnderQuestions from "../OverUnderQuestions/NFLOverUnderQuestions";
...
const NFLOverUnder = () => {
  ...
  const currentQuestion = NFLOverUnderQuestions[currentQuestionIndex];
  ...
  const handleNextQuestion = () => {
    setDisplayMessage("");
    setSelectedButton("");
    if (currentQuestionIndex < NFLOverUnderQuestions.length - 1) {
