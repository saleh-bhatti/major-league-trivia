...
import EPLOverUnderQuestions from "../OverUnderQuestions/EPLOverUnderQuestions";
...
const EPLOverUnder = () => {
  ...
  const currentQuestion = EPLOverUnderQuestions[currentQuestionIndex];
  ...
  const handleNextQuestion = () => {
    ...
    setDisplayMessage("");
    setSelectedButton("");
    if (currentQuestionIndex < EPLOverUnderQuestions.length - 1) {
      setCurrentQuestionIndex(currentQuestionIndex + 1);
    } else {
      setGameOver(true);
